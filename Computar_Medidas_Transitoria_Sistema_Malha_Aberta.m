%% A) Computar as medidas transitorias para as funcoes parciais         
...
%% B) Construir Tabela para Verificar medidas transitoria associadas aos 
%     polos complexos conjugados
    
    %B.1) Polos escritos na forma de numero complexo
